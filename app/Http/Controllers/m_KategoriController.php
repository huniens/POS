...
class m_barangController extends Controller
{
    ...
    {
        $barangs = m_barang::select('barang_id', 'kategori_id', 'barang_nama', 'barang_kode', 'harga_beli', 'harga_jual')->with('kategori');
    ...
    {
        $barang = m_barang::find($id);
        $kategori = m_kategori::select('level_id', 'level_nama')->get();
