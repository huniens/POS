@extends('layouts.template')
 ...
 <div class="card card-outline card-primary">
     <div class="card-header">
         <h3 class="card-title">{{ $page->title ?? 'Tambah Penjualan Detail' }}</h3>
         <div class="card-tools"></div>
     </div>
     <div class="card-body">
         <form method="POST" action="{{ route('penjualan_detail.store') }}" class="form-horizontal">
             @csrf
             ...
             <div class="form-group row">
                 <div class="col-10 offset-2">
                     ...
                     <a href="{{ route('penjualan_detail.index') }}" class="btn btn-sm btn-secondary ml-1">Kembali</a>
                 </div>
             </div>
         </form>
     </div>
